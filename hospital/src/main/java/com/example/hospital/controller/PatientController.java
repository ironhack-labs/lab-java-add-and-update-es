...
public class PatientController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Patient> updatePatient(@PathVariable Long id, @RequestBody Patient patient,@PathVariable String status) {
        return ResponseEntity.ok(patientService.updatePatient(id,patient,status));
