...
public class EmployeeService {
  ...
  public Optional<EmployeeResponse> updateEmployeeStatus(Long id, UpdateEmployeeStatusRequest updateEmployeeStatusRequest) {
  ...
  public Optional<EmployeeResponse> updateEmployeeDepartment(Long id, UpdateEmployeeDepartmentRequest updateEmployeeDepartmentRequest) {
    Optional<Employee> optionalEmployeeFromDb = employeesRepository.findById(id);
    return optionalEmployeeFromDb.map(employee -> {
      employee.setDepartment(updateEmployeeDepartmentRequest.getDepartment());
      Employee updatedEmployee = employeesRepository.save(employee);
      return employeeMapper.fromEmployeeToDtoEmployeeResponse(updatedEmployee);
    });
  }
